...
export class ManageProductService {
  ...
  /**
   * check if the user is not the product creator or admin, then do not continue
   */
  validatePrivilege({
    userIdRequest,
    roleNameRequest,
  ...
  /**
   * @description: get list of products of a shop, must pass query param `createdById`
   */
